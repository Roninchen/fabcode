...
var (
	...
	org           = "org1"
	user          = "Admin"
	//configPath    = "$GOPATH/src/github.com/hyperledger/fabric/asset/application/config.yaml"
...
func channelExecute(fcn string, args [][]byte) (channel.Response, error) {
	...
	fmt.Println("=========================交易ID=========================")
	fmt.Println(channel.Response{}.TransactionID)
	fmt.Println("=========================交易ID=========================")
	...
	block, err := c.QueryBlockByTxID(resp.TransactionID)
	if err != nil {
